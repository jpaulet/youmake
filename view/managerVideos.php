            ...
            <div class='row'>
                <div class="col-xs-12" style='background-color: #fff;padding:30px'>
                    ...
                    <?php if (User::isAdmin()) { ?>
                        ...
                        <a href="<?php echo $global['webSiteRootURL']; ?>users" class="btn btn-default">
                            <span class="fa fa-user"></span> <?php echo __("Users"); ?>
                        </a>
                    <?php } ?>
                        <a href="<?php echo $global['webSiteRootURL']; ?>charts" class="btn btn-default">
                        ...
                        if (User::isAdmin()) {
                            ?>
                            <a href="<?php echo $global['webSiteRootURL']; ?>ads" class="btn btn-default">
                    ...
                    <small class="text-muted clearfix" style='margin-top:20px;margin-bottom:10px;'>
                        <?php
                    ...
                    <div class="pull-left btn-group" style='margin-top:20px;margin-bottom:-40px;'>       
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary youmake-button" id="saveCategoryBtn"><?php echo __("Save changes"); ?></button>
                                </div>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
                    </div><!-- /.modal -->
                    ...
                    if ((User::isAdmin())&&(!$config->getDisable_youtubeupload())) {
                        ...
                        <div class="alert alert-info" style='background-color:#dbbffc33;color:#3c116bb3;border:0px;'>
                            ...
                            <ol>
                                <li>
                                    <a href="<?php echo $global['webSiteRootURL']; ?>siteConfigurations" class="btn btn-info btn-xs youmake-button" style="height:24px;line-height:20px;padding:2px 8px;">Enable Google Login</a> and get your google ID and Key
                                </li>
                                <li>
                                    Go to https://console.developers.google.com
                                    on <a href="https://console.developers.google.com/apis/dashboard" class="btn btn-info btn-xs youmake-button" target="_blank" style="height:24px;line-height:20px;padding:2px 8px;">dashboard</a> Enable <strong>YouTube Data API v3</strong>
                                </li>
                                <li>
                                    In credentials authorized this redirect URIs <code><?php echo $global['webSiteRootURL']; ?>objects/youtubeUpload.json.php</code>
                                </li>
                                <li>
                                    You can find more help on <a href="https://developers.google.com/youtube/v3/getting-started" class="btn btn-info btn-xs youmake-button"  target="_blank" style="height:24px;line-height:20px;padding:2px 8px;">https://developers.google.com/youtube/v3/getting-started </a>
                                </li>
                            </ol>
