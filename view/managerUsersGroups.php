...
<html lang="<?php echo $_SESSION['language']; ?>">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class='row'>
                <div class="col-xs-12" style='background-color: #fff;padding:20px 30px'>
                    <div class="btn-group" >
                        ...
                        <a style="background-color:#fff;" href="#" class="btn btn-default pull-right" data-toggle="popover" title="<?php echo __("What is User Groups"); ?>" data-placement="bottom" data-content="<?php echo __("This is where you can create groups and associate them with your videos and users. This will make your videos private. Only users who are in the same group as the videos can view them"); ?>"><span class="fa fa-question-circle" aria-hidden="true"></span> <?php echo __("What is User Groups"); ?>
                        </a>
                    </div>
