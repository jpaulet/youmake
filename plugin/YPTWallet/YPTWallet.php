...
class YPTWallet extends PluginAbstract {
    ...
    public function getEmptyDataObject() {
        ...
        $obj->add_funds_text = "<h2 style='margin-left:0px;padding-left:0px;'>Adding money instantly from credit/debit card</h2>Add funds on your Account Balance, to support the community videos, promote channels, videos & more!";
